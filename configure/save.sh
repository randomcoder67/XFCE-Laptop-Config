...
sed 's/USERNAMEA/GENERICUSERNAME/g' ~/.config/xfce4/xfconf/xfce-perchannel-xml/xfce4-panel.xml | sed '/		<value type="string" value="wi-fi network connection/d' > ~/Programs/configure/xfce4/xfce4-panel-$currentTheme.xml
